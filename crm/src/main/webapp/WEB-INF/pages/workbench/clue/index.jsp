...
<script type="text/javascript">
	...
	function queryAllClues() {
		$.ajax({
			url:'workbench/clue/selectAllClues.do',
			type:'post',
			dataType:'json',
			success:function (data) {
				if(data.code == "1") {
...
<%--						<tr>--%>
<%--							<td><input type="checkbox" /></td>--%>
<%--							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detailClue.do?id=9fb07ea872d34fd2aa87b0e9856862ec';">Lois Lu先生</a></td>--%>
<%--							<td>动力节点</td>--%>
<%--							<td>010-84846003</td>--%>
<%--							<td>12345678901</td>--%>
<%--							<td>广告</td>--%>
